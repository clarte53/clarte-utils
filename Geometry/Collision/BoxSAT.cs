...
namespace CLARTE.Geometry.Collision
{
    ...
    public static class BoxSAT
    {
        ...
        /// <param name="b">The second box.</param>
        /// <returns>True if the two boxes are colliding, false otherwise.</returns>
        /// TODO: evaluate direction and distance
        public static bool Collision(this BoxCollider a, BoxCollider b, out Vector3 direction, out float distance)
        {
		...
		public static bool Collision2D(this BoxCollider a, BoxCollider b, out Vector3 direction, out float distance)
        {
            ...
            //    distX = a_x_max - b_x_min;
            //}
            ////chevauchement à gauche
            //if (b_x_max > a_x_min)
            //{
            //    dirX = -a.transform.right;
            //    distX = b_x_max - a_x_min;
            //}
            ...
            //{
            //    dirY = a.transform.up;
            //    distY = a_y_max - b_y_min;
            //}
            ////chevauchement en bas
            //if (b_y_max > a_y_min)
            //{
            //    dirY = -a.transform.up;
            //    distY = b_y_max - a_y_min;
            //}
